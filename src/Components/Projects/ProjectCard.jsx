...
const ProjectCard = ({projectName, deployURL, githubURL, logo, projectDesc}) => {
  return (
    <div className='rounded-lg p-2 w-72 h-96 flex flex-col gap-3 justify-between items-center border border-sky-600 bg-teal-50 shadow-md hover:bg-teal-100 transition-colors duration-300'>
      <img src={logo} className='rounded-xl max-w-56 '></img>
